...
\usepackage{dcolumn, multirow, multicol}
...
% controls the appearance of the code blocks
% this is for aesthetics only, not essential for LaTeX
\usepackage{listings}
\definecolor{lgray}{gray}{0.925}

\lstset{ 
  backgroundcolor = \color{lgray},
  basicstyle = \small \ttfamily,  % code style
  ...
  % frame = single,              % code block border
  keepspaces = true,   % keeps spaces for indentation (needs columns = flexible)
